...
Module ModuleDescription
    Public crypt As New CryptText("SMKNUSAJAYA-ScoresAttendanceSMSGateway-SMKNUSAJAYA-ScoresAttendanceSMSGateway-")
    Public rConfig As New ReadConfig
    Public aUser As New ClassActiveUser
    Public oClassExam As New ClassExam
    Public oClassAttendance As New ClassAttendance
...
#Region "Random Keys"
    ...
    Public Function getDateString() As String
        ...
        finalCode = String.Format("{0}", trimmedCode, GetUniqueKey(3))
        Return finalCode
    End Function
